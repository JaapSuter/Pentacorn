...
namespace Pentacorn.Graphics
{
    class Renderer
    {
        public Renderer(IntPtr hwnd)
        {
            ...
            SketchPostEffect = RendererImpl.Loader.Load<Effect>("Content/Shaders/SketchPost");            
        }
        ...
        public void RenderInto(Scene scene, Window window)
        {
            ...
            RendererImpl.Device.SetRenderTarget(RendererImpl.RenderTarget2E);
            ...
            SketchPostEffect.Parameters["WorldViewProj"].SetValue(RendererImpl.Device.Viewport.Size().WorldViewProjectionForPixels2d());
            SketchPostEffect.Parameters["Texture"].SetValue(RendererImpl.RenderTarget2E);
            SketchPostEffect.Parameters["Color"].SetValue(Color.White.ToVector4());
            
            RendererImpl.SpriteBatch.Begin(SpriteSortMode.Immediate, null, null, null, null, SketchPostEffect, Matrix.Identity);
            RendererImpl.SpriteBatch.Draw(RendererImpl.RenderTarget2E, Vector2.Zero, Color.White);
        ...
        private Effect SketchPostEffect;
