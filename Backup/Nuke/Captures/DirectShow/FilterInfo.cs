...
namespace Pentacorn.Vision.Captures.DirectShow
{
    using System;
    ...
    class FilterInfo : IComparable
    {
        ...
        /// 
        public static void CreateFilter(string filterMoniker, out IBaseFilter baseFilter)
        {
            baseFilter = null;
            ...
            if (Win32.CreateBindCtx(0, out bindCtx) == 0)
            {
                ...
                {
                    object baseFilterObj = null;
                    Guid filterId = typeof(IBaseFilter).GUID;
                    moniker.BindToObject(null, null, ref filterId, out baseFilterObj);
                    baseFilter = (IBaseFilter)baseFilterObj;
