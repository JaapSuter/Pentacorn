...
namespace Pentacorn.Vision.Captures.DirectShow
{
    ...
    /// </remarks>
    /// 
    class FilterInfoCollection : CollectionBase
    {
        /// <summary>
        ...
        /// 
        public Pentacorn.Vision.Captures.DirectShow.FilterInfo this[int index]
        {
            get
            {
                return ((Pentacorn.Vision.Captures.DirectShow.FilterInfo) InnerList[index] );
            }
        }
